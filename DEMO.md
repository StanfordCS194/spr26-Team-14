...
- *"**Monitoring** is your product manager's favourite tab*
- *Here at the top we have "The **7-day trend** is a coarse **health line**: AI outputs are **non-deterministic**; the honest operational model is **re-run the same prompts on a cadence** and watch drift. This chart is your early warning without spamming chat by hand."*
- Each prompt in the table is a real user-style query we gathered from our customer discovery phase — ‘best streaming for families’, ‘who leads’, etc."*
...
- *"In the **Add a prompt** field*: your PMM can add a bet, and we expand coverage.
